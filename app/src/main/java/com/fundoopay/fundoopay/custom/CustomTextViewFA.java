...
/**
 * Created by bridgeit on 10/10/17.
 */

public class CustomTextViewFA extends AppCompatTextView {
    ...
    public static String fontName="font/avnir.ttf";

    public CustomTextViewFA(Context context) {
        super(context);
        init(null);
    }

    public CustomTextViewFA(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CustomTextViewFA(Context context, AttributeSet attrs, int defStyle) {
